    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_or_post', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('savings_total', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posters.Book')),
